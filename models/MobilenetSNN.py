...
class MBNETSNN_NegQ(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.features = nn.Sequential(
            SConv(3, 32, 3, 1, 1, pool=True, neg=-5.0),
            SConvDW(32, 64, 3, 1, 1, pool=True, neg=-5.0),
            SConvDW(64, 64, 3, 1, 1, pool=True, neg=-2.0),
            SConvDW(64, 128, 3, 1, 1, pool=True, neg=-2.0),
            SConvDW(128, 128, 3, 1, 1, pool=True, neg=-2.0),
        )
